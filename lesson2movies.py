...
movie_titles = ['Empire Records', 'Aladdin', 'Beasts of the Southern Wild', 'Tank Girl', 'Hedwig and the Angry Inch']
parental_rating = ['PG-13', 'G', 'PG-13', 'R', 'R']
bechdel_rating = ['3', '0', '3', '3', '3']
imdb_rating = ['6.7', '8.0', '7.3', '5.1', '7.8']
genre = ['Comedy / Drama / Music', 'Adventure / Animation / Comedy', 'Drama / Fantasy', 'Action / Comedy / Sci-Fi', 'Comedy / Drama / Music']

print "Title, Rating, Bechdel, IMDB, Genre"

for (movie, parent, bechdel, imdb, genree) in zip(movie_titles, parental_rating, bechdel_rating, imdb_rating, genre):
	print "{0}, {1}, {2}, {3}, {4}".format(movie, parent, bechdel, imdb, genree)
